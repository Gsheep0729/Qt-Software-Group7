...
template <> constexpr inline auto GoToCellDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14GoToCellDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<GoToCellDialog, qt_meta_tag_ZN14GoToCellDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject GoToCellDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14GoToCellDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14GoToCellDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14GoToCellDialogE_t>.metaTypes,
    nullptr
} };
...
void *GoToCellDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14GoToCellDialogE_t>.strings))
